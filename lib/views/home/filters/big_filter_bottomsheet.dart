...
class Filters extends StatelessWidget {
  ...
  final List carNumberDoor = [2, 3, 4, 5, 6, 7];

  final List carNumberSit = [1, 2, 3, 4, 5, 6, 7, 8, 9];
                  ...
                  child: ElevatedButton(
                      style: ButtonStyle(
                        backgroundColor:
                          ...
                          (Set<MaterialState> states) => c.togglePrice.value
                              ? AppTheme.light
            ...
            itemBuilder: (context, index) {
              return Obx(() {
                return ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                          c.carTypeList[index]['title'] == c.selectedType.value
                              ? AppTheme.primaryColor
                              : AppTheme.light),
                      overlayColor:
                          MaterialStateProperty.all(Colors.transparent),
              ...
              Expanded(
                  child: ElevatedButton(
                      style: ButtonStyle(
                        backgroundColor:
                            MaterialStateProperty.resolveWith<Color>(
                          (Set<MaterialState> states) => c.gearBox.value
                              ? AppTheme.light
                              : AppTheme.primaryColor,
                        ),
                        overlayColor:
                  ...
                  return ElevatedButton(
                      ...
                      child: SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                                "${c.doorList[index]} ${index == c.doorList.length - 1 ? '+' : ''}",
                                style: TextStyle(
                                    fontSize: 15,
                  ...
                  return ElevatedButton(
                      ...
                      child: SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                                "${c.placesList[index]} ${index == c.placesList.length - 1 ? '+' : ''}",
                                style: TextStyle(
                                    fontSize: 15,
